...
const LOGO_DESKTOP =
  'https://http2.mlstatic.com/frontend-assets/ml-web-navigation/ui-navigation/6.6.130/mercadolibre/logo_large_plus@2x.webp';
const LOGO_MOBILE =
  'https://http2.mlstatic.com/frontend-assets/ml-web-navigation/ui-navigation/6.6.130/mercadolibre/logo__small@2x.png';
const MELI_PLUS_BANNER = 'https://http2.mlstatic.com/D_NQ_724333-MLA84405973064_052025-OO.webp';
...
export default function Header() {
  return (
    <header
      ...
      role="banner"
    >
      <div className="flex h-12 meli-md:h-auto meli-md:grid meli-md:grid-cols-[162px_minmax(340px,588px)_minmax(350px,390px)] gap-x-5 py-[7px] px-2.5 meli-md:pt-2 meli-md:pb-3 meli-md:px-2.5 max-w-[1200px] mx-auto items-center">
        <HeaderLogo />
        <HeaderSearch />
        <HeaderActions />
      </div>
